...
const tareasEjemplo = [
  {
    ...
    descripcion: "Vencimiento de Tarea - ZISVIIA-Electiva Disciplinar (Redes) 25-2",
  },
  {
    id: 2,
    fecha: "2025-11-19",
    ...
    descripcion: "Vencimiento de Tarea - ZISVIIA-Legislación del Software REMOTO 25-2",
  },
  {
    id: 3,
    fecha: "2025-11-21",
    hora: "00:00",
    titulo: "ACTIVIDAD PRÁCTICA: Instalación de Splunk y Análisis Básico de Logs",
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-6">Línea de tiempo</h2>
              ...
              <tbody>
                ...
                {(() => {
                  ...
                  diasMes.forEach((dia, idx) => {
                    ...
                    if ((dia.getDay() === 0 && semana.length) || idx === diasMes.length - 1) {
                      // Fin de semana o fin de mes
                      while (semana.length < 7) semana.push(<td key={"empty-end-" + semana.length}></td>);
                      semanas.push(<tr key={"semana-" + semanas.length}>{semana}</tr>);
                      semana = [];
                    }
                  });
                  return semanas;
