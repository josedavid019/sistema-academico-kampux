...
from .views import (
    ...
    UsuarioListAPIView, UsuarioDetailAPIView, EstudianteListAPIView, EstudianteDetailAPIView,
    DocenteListAPIView, DocenteDetailAPIView, CoordinadorListAPIView, CoordinadorDetailAPIView,
    AdministradorListAPIView, AdministradorDetailAPIView
)
...
urlpatterns = [
    ...
    path('estudiantes/<int:pk>/', EstudianteDetailAPIView.as_view(), name='estudiantes-detail'),
    ...
    path('coordinadores/all/', CoordinadorListAPIView.as_view(), name='coordinadores-list'),
    path('coordinadores/<int:pk>/', CoordinadorDetailAPIView.as_view(), name='coordinadores-detail'),

    path('administradores/all/', AdministradorListAPIView.as_view(), name='administradores-list'),
    path('administradores/<int:pk>/', AdministradorDetailAPIView.as_view(), name='administradores-detail'),
